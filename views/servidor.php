...
<a href="cliente_p.php">
		...
		<center>
<br>
<h1>Servidores Dedicados para almacenamiento</h1>
		<body>
			<br>
			<p> <font size="6px"> Necesitas almacenamiento y disponibilidad para un enorme volumen de datos? Como único ocupante de tu servidor dedicado, toda la capacidad de la máquina estará a tu disposición. Te garantizamos el mejor hardware del mercado para un servidor dedicado 100% fiable y con uptime garantizado.</p>
			...
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			 <img src="../css/imagenes/servidord.png" width="1200px"> 
<br><br>
 <div class="col-md-4">
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <a href="Web_Hosting.view.php"><button type="button" class="btn btn-success btn-lg btn-block">INICIO</button></a></center>
</section>
