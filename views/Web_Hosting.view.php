...
<head>
	...
	<script type="text/javascript">
		var _smartsupp = _smartsupp || {};
			_smartsupp.key = '95915c78d069ab4ed69422606a909cd72b0f908d';
...
<section id="noticias">
<a href="web.php">
		<img id="web" src="../css/imagenes/web.png">
	</a>
<a href="servidor.php">
		<img id="servidor" src="../css/imagenes/servidor.png">
	</a>
<a href="poliza.php">
		<img id="poliza" src="../css/imagenes/poliza.png">
	</a>
<a href="porque.php">
		<img id="porque" src="../css/imagenes/porque.png">
	</a>
<a href="centro.php">
		<img id="centro" src="../css/imagenes/centro_ayuda.png">
	</a>
<a href="dominios.php">
		<img id="dominios" src="../css/imagenes/dominios.png">
	</a>
<a href="mas.php">
		<img id="mas" src="../css/imagenes/mas.png">
	</a>
<a href="tec.php">
		<img id="tec" src="../css/imagenes/tec.png">
	</a>
<a href="resellers.php">

		<img id="resellers" src="../css/imagenes/resellers.png">
	</a>
	<a href="pregunta.php">
		<img id="preguntas" src="../css/imagenes/preg.png">
	</a>
  ...
  ponerte en contacto con nosotros a:
	...
	<font size="5px"> <a id="administrador" href="login.php" style="color:white">  &nbsp&nbsp&nbsp &nbsp&nbsp Administrador</a> </font>
</section>
