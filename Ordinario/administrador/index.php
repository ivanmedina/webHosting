...
<font color="white"><center>
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:50px;" >
 ...
 <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a href="?action=editar&id=<?php echo $r->id; ?>" style="color:white">Editar</a>
                            </td>
                            <td>
                                <a href="?action=eliminar&id=<?php echo $r->id; ?>" style="color:white">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
